...
library(MASS) #includes the glmmPQL function
...
library(xtable) #???
library(stargazer) #used to create Table 1
...
#lines 62-83 of this code are based on (though not identical to) the code written by Harvardstudents in their previous replication of this paper.  Citation : Noam Gidron; Jeffrey Javed, 2011, "Replication data for: The Unholy Trinity: Immigration, Unemployment and Extremism in Europe, 1980-2002", http://hdl.handle.net/1902.1/15902 V1 [Version]
